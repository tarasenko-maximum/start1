...
const INITIAL_CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    author: 'Виктор Соловьев',
    genre: 'Научная фантастика / Киберпанк',
    vibe: 'Высокие ставки',
    description: 'Увлекательный научно-фантастический роман о колонизации Марса и первом контакте с древней подземной биосферой. Динамичный сюжет о выживании человечества в экстремальных космических условиях.',
    coverUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCQ35-Eu11sNUeEaPdNHq8lGam2UvBRbXRKxkiEGofbkP4p7yEFw0mBHr6AiXWHAZo7jKSbZ3zZCTh7kK5RehxgBKRpe23DM-ZBzyAl6y2aUV93-4AtjWLw7ZDhENZB1gZuCo1KGTYd4zDRdJChoryz6p9WX9_DGV7L7rFmcqFFUhWKcSUqK6RgkmJXOxkKCzSJuxBvz60NOVtggZuP_8k7vhw8Cm2VP7FPMEBcPd4BTqp_GoSKXYviWP9bdi-mJYykCKM-W5Mc7uA',
    ...
    coverType: 'hard',
    paperType: 'white',
    authorBio: 'Виктор Соловьев — физик-астроном, популяризатор науки и писатель-фантаст.',
    samplePages: SAMPLES.default,
    bonuses: [{ minAmount: 1300, description: '1 экз. книги с доставкой.' }],
    crossSells: ['1', '2']
  },
  {
    id: '7',
    title: 'Следы на Воде',
    author: 'Анна Воронова',
    genre: 'Современная проза / Поэзия',
    vibe: 'Меланхолия',
    description: 'Поэтический сборник о поиске себя в суете больших городов, вдохновленный туманами Санкт-Петербурга и тихими вечерами на Финском заливе.',
    coverUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuADyFfYRqd0geczzJge1asDN-_sx6L293vXtV17NyYQVcN8RPOZ4PfLIMslNRrBaF5YcMUA3gtdfqCUBacxQFvfPd62JubYpj1G3JqTVlEGEOXU0Uq4sHbP_YgifoYjz8INUhzKDbdlblDUvkswXMS-3vW9E7JS86XIEV8KfGuAYpethJy3SWjIF3yNLaMvpRsSGFLzzKFgyxPMg9h6gKuOOwmggppid9ectiWGNZS0yQMokqEDy3YsT_tK6iSl2nHIS9dpoXEgoWY',
    targetFunding: 80000,
    ...
    coverType: 'soft',
    paperType: 'cream',
    authorBio: 'Анна Воронова — филолог, лауреат молодежных поэтических конкурсов.',
    samplePages: SAMPLES.default,
    bonuses: [{ minAmount: 900, description: '1 экз. книги с доставкой.' }],
    crossSells: ['1', '4']
  },
  {
    id: '8',
    title: 'Квантовая Осень',
    author: 'Илья Кротов',
    genre: 'Научная фантастика / Философия',
    vibe: 'Интеллект',
    description: 'Философская притча о путешествиях во времени и парадоксах квантового сознания. Как меняется реальность, когда наблюдатель решает изменить свое прошлое?',
    coverUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC8g3c9r6TGtiHHSAGJrIwPVCXy9xqSLdlRGcZzfySq0GnOQluIUvfd_qz0gWiZH6zV-5Rq_3mVJG58j8b3AVCf6EYJFuPMShXgrlGQTX8Tvtx5VMmBY0Mo1fslD1fJy3GWu8g6AX0MeEbV7OWGnWG84SPWNCmL4ijq4PQZkTIZmlCcMC5tC23RKSCOa8FQBzn6YKOK6YKTfY3pYLB0zvnJNzQ2W9XPU0NC9_h570CnxCxc48ivj-V1-cVFcdihDp7HPRCHJpNiYNk',
    targetFunding: 130000,
    ...
    coverType: 'hard',
    paperType: 'white',
    authorBio: 'Илья Кротов — программист, исследователь искусственного интеллекта и писатель.',
    samplePages: SAMPLES.default,
    bonuses: [{ minAmount: 1200, description: '1 экз. книги с доставкой.' }],
    crossSells: ['3', '2']
  },
  {
    id: '9',
    ...
    vibe: 'Интеллект',
    description: 'Занимательная математика для широкого круга читателей. Как числа управляют нашей повседневной жизнью, экономикой и искусством.',
    coverUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBhevZ3BomrFosq2T_m2wRUl-AudShIXV3geJOWKvBmYPqio1aVe9mo4JmuJ2lbMB5ER8ogYzlSJW82z8q--5rz2LOn_W5u1pvDDnL0la54uZWep4Z8TktYDi_Gzq5M8CTL9muZqJyyzR1UwtjBWxg2_vlbNf4MRDEzTW4_KVRzLdVLDnjEyY6x0smzRUgtRDeruACy9WP2M9Kq0m1xHcdYdKMcS52t4KdB4h6MkF2Kytxq-3AuY0yrCCgK_cIvdhSD9cCjeSjRc8Y',
    targetFunding: 100000,
    ...
    coverType: 'soft',
    paperType: 'white',
    authorBio: 'Доктор физико-математических наук, профессор МГУ им. М.В. Ломоносова.',
    samplePages: SAMPLES.default,
    bonuses: [{ minAmount: 1100, description: '1 экз. книги с доставкой.' }],
    crossSells: ['3', '1']
  }
